            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-10 text-right">
                    <div class="menuWrap">
                        ...
                        <ul class="menu d2">
                            <li>
                                <a href="tel:+18882852656" class="header-btn bordered"> +1 (888) 285 2656 </a>
                            </li>
                            <li>
                                <a href="javascript:;" class="header-btn" onclick="setButtonURL()">Live Chat Now</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <ul class="bottom-menu">
                            <li class="has-child">
                                <a href="javascript:;">Ghost Writing</a>
                                <div class="dropdown">
                                    <ul>
                                        <li><a href="/ghostwriting-children-book/">Children’s Books</a></li>
                                        <li><a href="/ghostwriting-article-writing/">Article Writing </a></li>
                                        <li><a href="/ghostwriting-business-book/">Business Books</a></li>
                                        <li><a href="/ghostwriting-self-help/">Self Help Books</a></li>
                                        <li><a href="/ghostwriting-comics-book/">Comic’s Graphic Books</a></li>
                                        <li class="has-child"><a href="javascript:;">Others</a>
                                            <div class="dropdown">
                                                <ul>
                                                    <li><a href="/ghostwriting-memoir/">Memoirs</a></li>
                                                    <li><a href="/ghostwriting-auto-biography/">Autobiography</a></li>
                            ...
                            <li class="has-child">
                                ...
                                <div class="dropdown">
                                    <ul>
                                        <li><a href="/editing-children-book-editing/">Children’s Book Editing</a></li>
                                        <li><a href="/editing-beta-reader/">Beta Reader Testing</a></li>
                                        <li><a href="/editing-sensitive-reading/">Sensitive Reading</a></li>
