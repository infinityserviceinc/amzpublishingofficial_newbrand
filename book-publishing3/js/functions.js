...
!(function (t) {
        ...
        (y.prototype = {
            ...
            _generateMarkup: function () {
                ...
                i.appendTo(this.flagsContainer),
                    (this.selectedFlagInner = t("<div>", { class: "iti-flag" }).appendTo(i)),
                    this.options.separateDialCode && (this.selectedDialCode = t("<div>", { class: "selected-dial-code" }).appendTo(i)),
                    this.options.allowDropdown
                        ? (i.attr("tabindex", "0"),
                          t("<div>", { class: "iti-arrow" }).appendTo(i),
                          (this.countryList = t("<ul>", { class: "country-list hide" })),
                          this.preferredCountries.length && (this._appendListItems(this.preferredCountries, "preferred"), t("<li>", { class: "divider" }).appendTo(this.countryList)),
                          this._appendListItems(this.countries, ""),
                          (this.countryListItems = this.countryList.children(".country")),
                          this.options.dropdownContainer ? (this.dropdown = t("<div>", { class: "intl-tel-input iti-container" }).append(this.countryList)) : this.countryList.appendTo(this.flagsContainer))
                        : (this.countryListItems = t()),
                    this.options.hiddenInput && (this.hiddenInput = t("<input>", { type: "hidden", name: this.options.hiddenInput }).insertBefore(this.telInput));
            },
            ...
            _setDropdownPosition: function () {
                ...
                if ((this.options.dropdownContainer && this.dropdown.appendTo(this.options.dropdownContainer), (this.dropdownHeight = this.countryList.removeClass("hide").outerHeight()), !this.isMobile)) {
                    ...
                    if ((this.countryList.toggleClass("dropup", !a && r), this.options.dropdownContainer)) {
                        ...
                        this.dropdown.css({ top: n + l, left: s.left }),
            ...
            _getCountryData: function (t, e, i) {
                for (var s = e ? v : this.countries, n = 0; n < s.length; n++) if (s[n].iso2 == t) return s[n];
                if (i) return null;
    ...
    for (
        ...
        var w = v[C];
        v[C] = { name: w[0], iso2: w[1], dialCode: w[2], priority: w[3] || 0, areaCodes: w[4] || null };
    }
}),
    ...
    $(document).ready(function () {
        ...
        $(".salecrcle-btn").click(function () {
            ...
            $(".AWA-slider").slick({
                ...
                autoplaySpeed: 1e3,
                adaptiveHeight: !0,
                responsive: [{ breakpoint: 767, settings: { dots: !1, arrows: !1, slidesToShow: 1, slidesToScroll: 1 } }],
            }),
            $(".book-covers").slick({
                dots: !1,
                arrows: !0,
            ...
            $(".cs-slider").slick({ dots: !1, arrows: !1, infinite: !0, speed: 1e3, slidesToShow: 1, autoplay: !0, autoplaySpeed: 4e3, adaptiveHeight: !0 }),
            $(".portslider").slick({ dots: !0, arrows: !1, infinite: !0, speed: 1e3, slidesToShow: 1, autoplay: !1, slide: "li", adaptiveHeight: !0 }),
            $(".home-slider").slick({
                dots: !0,
                arrows: !0,
                infinite: !0,
                ...
                autoplaySpeed: 4e3,
                adaptiveHeight: !0,
                responsive: [{ breakpoint: 767, settings: { dots: !0, arrows: !1, slidesToShow: 1, slidesToScroll: 1 } }],
            }),
            $(".partnerslider").slick({ dots: !1, arrows: !1, infinite: !0, speed: 1e3, slidesToShow: 5, slidesToScroll: 1, autoplay: !0, autoplaySpeed: 2e3, adaptiveHeight: !0 });
        var t,
            e,
            i,
            s,
            ...
            o = 4;
        function a() {
            t.css({ width: "0%" }), clearTimeout(s), (n = 0), (i = !1), (s = setInterval(r, 10));
        }
        function r() {
            !1 === i && ((n += 1 / (o + 0.1)), t.css({ width: n + "%" }), n >= 100 && (e.slick("slickNext"), a()));
        }
        (e = $(".home-slider")),
        ...
        $.each({ 1: { slider: ".packslider" }, 2: { slider: ".boxwrap" } }, function () {
            $(this.slider).slick({
                arrows: !1,
                dots: !1,
                autoplay: !0,
            ...
            $(".product-slider-gallery").slick({ dots: !1, arrows: !1, infinite: !0, slidesToShow: 1, slidesToScroll: 1, speed: 800, autoplay: !0, autoplaySpeed: 3e3, asNavFor: ".product-gallery-nav" }),
            $(".product-gallery-nav").slick({
                ...
                responsive: [
                    ...
                    { breakpoint: 480, settings: { vertical: !1, slidesToShow: 2, slidesToScroll: 1 } },
                ],
            }),
            $(".thumb-slider").slick({
                centerMode: !0,
                ...
                slidesToScroll: 1,
                responsive: [
                    { breakpoint: 768, settings: { arrows: !1, dots: !1, centerMode: !0, centerPadding: "10px", slidesToShow: 3 } },
                    { breakpoint: 767, settings: { arrows: !1, dots: !1, centerMode: !1, centerPadding: "10px", slidesToShow: 1 } },
                    { breakpoint: 480, settings: { arrows: !1, dots: !1, centerMode: !0, centerPadding: "10px", slidesToShow: 1 } },
                ],
            }),
            $(".slider-for").slick({
                dots: !0,
            ...
            $(".gallery-slider-main").slick({ dots: !1, arrows: !1, infinite: !0, slidesToShow: 1, slidesToScroll: 1, speed: 1e3, autoplay: !0, autoplaySpeed: 2e3, fade: !0, cssEase: "linear", asNavFor: ".gallery-nav-main" }),
            $(".gallery-nav-main").slick({ slidesToShow: 5, slidesToScroll: 1, asNavFor: ".gallery-slider-main", dots: !0, focusOnSelect: !0 }),
            $(".bid-slider-gallery").slick({ dots: !1, arrows: !1, infinite: !0, slidesToShow: 1, slidesToScroll: 1, speed: 800, autoplay: !0, autoplaySpeed: 3e3, asNavFor: ".bid-gallery-nav" }),
...
$gallery.on("init", function (t, e) {
    ...
    $("#banform").validate({
        rules: { username: { required: !0, minlength: 2 }, email: { required: !0, email: !0 }, agree: "required" },
        messages: { username: { required: "Please enter a username", minlength: "Your username must consist of at least 2 characters" }, email: "Please enter a valid email address" },
    }),
    ...
    // }),
    $(".video-slider").slick({ dots: !0, speed: 500, fade: !0, cssEase: "linear", arrows: !1, slidesToShow: 3, slidesToScroll: 3, autoplay: !0, autoplaySpeed: 4e3 }),
    $("#modal-form").validate({
        rules: { cn: { required: !0 }, pn: { required: !0, minlength: 6 }, em: { required: !0 }, msg: { required: !0 } },
        errorPlacement: function () {
            return !1;
        },
    }),
    $("#bnr_form").validate({
        rules: { cn: { required: !0 }, pn: { required: !0, minlength: 6 }, em: { required: !0 }, srv: { required: !0 } },
        errorPlacement: function () {
            return !1;
        },
    }),
    ...
    $(".book-covers-2").slick({
        ...
        cssEase: "linear",
        adaptiveHeight: true,
        responsive: [{ breakpoint: 991, settings: { dots: !1, arrows: !1, slidesToShow: 1, slidesToScroll: 1 } }],
    });
