...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-web-copywriting/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Seo-Friendly Content That Tops Search Engines
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We focus on creating web content that resonates with your audience, prioritizing their needs
                            and preferences. Our content helps your business rank highly on search engines. From Contact
                            Us to Our Story pages, our writers create compelling content for real people, not bots.
                        </p>
                        <div class="btn-wrap">
