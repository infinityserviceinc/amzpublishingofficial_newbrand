...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-seo-content-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Don’t expect us to stuff keywords because such content does no good. Our experts optimize
                            the content for readers and search engines, with no compromises on readability and content
                            flow. Our content trends top on search engines, and it isn’t new for us to see our blogs
