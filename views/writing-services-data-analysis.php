...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-data-analysis/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Reach New Heights with Data Analysis Services
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Unorganized data coming from different streams always have a meaning for your business. We
                            use this data for your benefit and profitability. After verifying the data, we transform it
                            into the most helpful information that helps analyze your business operations qualitative
                            and quantitatively. Expertly conducted analysis helps your business crossing all the hurdles
                            to reach the ultimate success you desire.
                        </p>
                        <div class="btn-wrap">
