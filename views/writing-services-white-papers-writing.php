...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-white-papers-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Professionally-Crafted White Paper
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our expert writers know how to utilize their industry experience with thorough market
                            research to create an informative and persuasive white paper. We write customized content
                            that specifically defines your brand and generates quality leads. Choose the most efficient
                            team of writers and get the sales-driving white papers for your growing venture.
                        </p>
                        <div class="btn-wrap">
