...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Pioneers of Fiction and Expert Book Writers
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/ghostwriting-fiction/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            ...
                            Why Should You Choose Our Fiction Ghostwriters?
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We offer customized opportunities for the most personalized fiction ghostwriting. We are the
                            pioneers in sketching the most captivating plot and creating flair throughout our story. We
                            offer customers to get books belonging to a wide subgenre of fiction written by our writers
