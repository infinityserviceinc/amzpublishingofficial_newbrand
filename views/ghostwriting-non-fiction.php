...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get a Thoroughly Researched Book That Sells
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="assets/images/service/ghostwriting-non-fiction/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                        Top-Notch Non-fiction Ghostwriting Services
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our professional non-fiction ghostwriters compose pitched-perfect reading materials that
                            could be the next best sellers. Forget investing time and effort in writing a non-fiction
                            book; we are here with all the love and sincerity to write an exciting writeup that lures in
