...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Premium Paperback Publishing and Distribution Services
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/publishing-paperback-distribution/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Here’s What We Offer in Paperback Distribution
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Want to get your paperback book in the hands of readers everywhere? We take pride in
                            crafting a stunning interior layout that helps you make your book stand out on the shelves.
                            Our team design creative paperbacks that include all the essential elements like the Title
                            Page, Copyright Page, Dedication, and more. Let us help you build maximum exposure around
                            the world!
                        </p>
                        <div class="btn-wrap">
