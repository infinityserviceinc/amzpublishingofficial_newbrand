...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-web-design-development/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Establish Your Online Presence with a Responsive Website
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our professional design and development team is equipped with the modern tools and skills
                            necessary to build a creative and conversion-oriented design. We follow all the technical
                            updates and design a user-friendly website that provides an exceptional experience on all
                            devices.
                        </p>
                        <div class="btn-wrap">
