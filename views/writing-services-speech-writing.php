...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-speech-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Professionally-Crafted and Convincing Speeches
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our qualified writers absorb and understand your scope and purpose, audience’s demographics,
                            the environment you’ll be speaking in, your personality and cultural background. We ensure
                            writing a speech that personates the speaker perfectly. Let’s make it the speech of your
                            life!
                        </p>
                        <div class="btn-wrap">
