...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-guest-post-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            High-Quality Content to Improve Engagement
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We provide quality guest posts to help preserve your current position in the market and gain
                            more readerships. Introduce your brand to a new audience and increase credibility with our
                            guest posting. We help bring more traffic to your website and grow your social media
                            following to accelerate lead generation. Our guest posts have an incredible acceptance rate!
                        </p>
                        <div class="btn-wrap">
