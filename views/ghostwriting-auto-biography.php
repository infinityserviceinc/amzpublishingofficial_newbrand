...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="assets/images/service/ghostwriting-auto-biography/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                        Tell Your Tale with Our Quality Autobiography Writing Services
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our book writers have diverse skillset that ensures us to offer you a wide range of
                            autobiography book writing service. They strive to do justice with their work by
                            researching, brainstorming, revising, editing, and personalizing a manuscript for a client.
                            We add credibility with all the relevant information and trigger the emotions of our readers
                            with words.
                        </p>
                        <div class="btn-wrap">
