...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Representation Matters. Let Us Help You Get It Right!
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="assets/images/service/editing-sensitive-reading/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Misrepresentation or biases towards specific demographics in your manuscript, make it too
                            problematic to publish. Get rid of all the potential tropes from a prospective bestseller
                            that can make your narrative or characters less-than-great. We’ve got a diverse team of
                            professionals that spot discrepancies that others might not even know about!
                        </p>
                        <div class="btn-wrap">
