...
<body>
    ...
    <section class="banner" data-imgurl="assets/img/blog-writing-banner.jpg">
        <div class="container">
            <div class="row d-block">
                <div class="banner__grid">
                    <div class="content">
                        <h1>ACHIEVE YOUR GOAL OF MORE SALES OR PROMOTION USING BLOGS</h1>
                        <hr>
                        <div>
                            <p>Do you want your readers to be fully engaged with your stories? Do you require a
                                professional blog writing service? Our team of talented writers creates unique,
                                fascinating, pertinent, and thoroughly researched blog content for you.</p>
                            <div class="btn-group">
                    ...
                    <div class="banner-slide wow fadeInRight">
                        <figure>
                            <img loading="lazy" src="assets/img/transparent.svg"
                                data-imgurl="assets/img/blog-writing-img.png" class="w-100 text-center me-auto ms-auto"
                                alt="Ghost Writing">
                        </figure>
                ...
                <div class="col-md-10">
                    <div class="row align-items-center position-relative">
                        <div class="col-md-8 position-static">
                            <h2>FINDING THE RIGHT AUDIENCE IS MADE POSSIBLE WITHOUT SERVICES.</h2>
                            <hr>
                            <p>It is more important to target the right people with your advertising than the whole
                                public because of the competitive challenges that every company faces. Blogging may
                                bring you closer to better chances. Writing informatively about current events is an
                                essential way to connect with your target audience. So allow us to impress you with our
                                creativity!</p>
                            <div class="button">
                ...
                <div class="cta_inner d-flex">
                    ...
                    <div class="col-md-6">
                        <div class="cta_right wow fadeInRight">
                            <h3>Hire Us! At an Affordable Price, We Offer The Best Blog Writing Service</h3>
                            <h4>Have trouble coming up with new blog topics?</h4>
                            <div class="button">
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 mx-auto">
                    ...
                    <h4 class="heading">RAISE YOUR VIEWERS, AND APPRECIATION WILL FOLLOW</h4>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-title">Exclusive Details</div>
                            <div class="card-text">Our talented staff of bloggers creates 100% original and diverse
                                content for our clients at Books Writing Company.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/transparent.svg" data-imgurl="assets/img/guaranteed-secrecy.png"
                                alt="Guaranteed Content Secrecy">
                            <div class="card-title">Confidentiality of the content is assured.</div>
                            <div class="card-text">Our main goal is to give our customers complete security and
                                enjoyment. In return, we sign a confidentiality agreement promising to keep all
                                information about our clients private and secret.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/transparent.svg" data-imgurl="assets/img/quick-response.png"
                                alt="Quick Response">
                            <div class="card-title">Quick Reaction</div>
                            <div class="card-text">Each job is guaranteed to be finished ahead of schedule by our highly
                                qualified content writers so that we can collect client feedback and make any necessary
                                adjustments.</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-5">
                            <div class="card timeline-right-arrow">
                                <div class="card-body">
                                    ...
                                    <div class="card-text">
                                        We examine the book genre that our clients give us. Then, we choose the most
                                        important platforms and target markets for book promotion.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pt-4 timelineSec__box">
                        <div class="col-md-5 order-md-2">
                            <div class="card timeline-left-arrow">
                                <div class="card-body">
                                    <div class="card-title">
                                        Making Related Content
                                    </div>
                                    <div class="card-text">
                                        We create pertinent content for the target audiences of our clients, such as
                                        articles, blogs, and press releases, and disseminate it on the platforms of
                                        their choice.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-4  timelineSec__box">
                        <div class="col-md-5">
                            <div class="card timeline-right-arrow">
                                <div class="card-body">
                                    <div class="card-title">
                                        Video And Image Fusion
                                    </div>
                                    <div class="card-text">
                                        Relevant photographs and videos are used to enhance the blog's aesthetic appeal.
                                        Our marketers regularly update the content to ensure reader interest.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 order-md-2">
                            <div class="card timeline-left-arrow">
                                <div class="card-body">
                                    ...
                                    <div class="card-text">
                                        Based on the preferences of our clients, we are open to countless variations. As
                                        a result, we promise top-notch work in an effort to please and benefit our
                                        customers.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-text">
                                        The completion of the finished document does not mark the end of our efforts.
                                        You can see the benefits of your sales since we regularly send our clients
                                        information about the views, impressions, and visitors their Amazon page has
                                        received.
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="row align-items-center position-relative">
                        <div class="col-md-8 position-static">
                            <h2>DECORATE YOUR SITE WITH BLOGS WORTH READING</h2>
                            <hr>
                            <p>You've found it thanks to our knowledgeable blogging staff! We are capable of creating
                                well-known blogs.</p>
                            <div class="button">
                                <a href="get-a-quote/" class="btn btn__effect btn-hovereff">Get a Free Proposal</a>
                                <a href="javascript:void(Tawk_API.toggle())"
