...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get a Wonderful Biography from Writing Professionals  
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="assets/images/service/ghostwriting-biography/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                        Our Wordsmiths Write the Best Biographies
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We can assist you in creating an exceptional and personal bio after digging in the most
                            important information from trusted resources to add authenticity to work. We have separate
                            departments for different disciplines and ensure flawlessness and leave no area untouched
                            with expertness.
                        </p>
                        <div class="btn-wrap">
