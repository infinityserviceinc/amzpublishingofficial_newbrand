...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            We Represent Your Book for You
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/publishing-finding-literary-agent/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Frankly speaking, most of the renowned publishers do not accept direct submissions from
                            authors without some recommendations done by well-known book publishing agents. Therefore,
                            it is necessary to be represented by an agent in order to negotiate a satisfactory
                            publishing contract. Fortunately, we have contacts with the right people. So, what are you
                            waiting for? Hurry up and hire a literary agent today!
                        </p>
                        <div class="btn-wrap">
