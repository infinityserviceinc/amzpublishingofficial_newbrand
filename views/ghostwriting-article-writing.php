...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get Well-Written Articles for Your Target Audience
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/ghostwriting-article-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                        Articles That Turn Traffic Into Customers
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Need to generate more traffic for your website? Freelancers can be unreliable, and hiring a
                            full-time writer can be costly. We’re the sweet spot between the two that help you generate
                            growth for your online business. Our writers excel in creating original, industry specific
                            content about relevant trends. Boost your website ranking in no time!
                        </p>
                        <div class="btn-wrap">
