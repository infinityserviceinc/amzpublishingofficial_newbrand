...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get Your Content Checked by Experts!
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="assets/images/service/editing-proof-reading/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Meet your deadlines and perfect your first draft with our proofreading services catered to
                            your needs. Love to write but hate to edit? We’ve got your back. Set up your bestseller
                            novel, project, business proposal, or even a resume for success. We’ll fix grammar, sentence
                            structures, and spelling mistakes, so your work is more professional!
                        </p>
                        <div class="btn-wrap">
