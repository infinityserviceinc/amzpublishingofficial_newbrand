...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Work with the Finest Book Editors to Make Your Manuscript Flawless 
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/editing-book-review-consultation/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Comprehensive Book Review and Consultation Services
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our editors provide outstanding book editing services in compliance to proper grammar rules
                            and format outlines, while performing their expert book editing services. They work ardently
                            in order to revise and refine your manuscript and thereby prepare it for quick and swift
                            publication. Whether it is simple editing, ghostwriting, or rewriting, our adept and
                            proficient book writers are well-versed in making every manuscript error-free..
                        </p>
                        <div class="btn-wrap">
