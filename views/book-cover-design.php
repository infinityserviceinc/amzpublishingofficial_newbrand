    ...
    <?php include_once("includes/header.php")?> <main>
                ...
                <div class="banner-content">
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-12">
                            ...
                            <h1 class="theme-h1">Crafting The Most Creative Book Cover Designs in The Industry.</h1>
                            <p class="theme-p">It's not just about judging a book by its cover. An upstanding design can
                                manipulate the way a
                                book is perceived by readers. Our innovative designers at AMZ Publishing Official. know
                                precisely
                                how to generate sales through brilliant design.</p>
        ...
        <section class="who-we-are padding-sec">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-12">
                        <h2 class="theme-h2">Make your Cover stand out!</h2>
                        <p class="theme-p">To captivate the readers, our industry-oriented designers use their
                            distinctive artistic
                            skillset to make an impact on the cover, which tells more about the story. AMZ Publishing Official
                             consists of hardworking designers who make sure to attract readers at first
                            sight of your book by providing creative book cover design.</p>
                        <ul class="theme-btn-ul">
                            <li>
                                <a class="theme-btn theme-btn-dark btn-icon"
                                    href="javascript:;$zopim.livechat.window.toggle()">live chat</a>
        ...
        <section class="how-book-publishing-work padding-sec">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6 col-12">
                        <h2 class="theme-h2">Our approaching method is concentric and revealing</h2>
                    </div>
                    ...
                    <div class="row justify-content-center g-4">
                        <div class="col-md-6 col-12">
                            <div class="publishing-work-card">
                                ...
                                <h4 class="theme-h3">Far-Reaching Expertise</h4>
                                <p class="theme-p">Our limits are to the skies and beyond—our team, which specializes in
                                    multiple genres,
                                    be it a piece of history or autobiography, exceptional quality of content with
                                    unrivaled
                                    support is ensured.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="publishing-work-card">
                                <img src="images/02.webp" alt="image">
                                <h4 class="theme-h3">Individually Customized Services</h4>
                                <p class="theme-p">The purpose of this type of service is to provide you with the
                                    correct expert based on the
                                    genre you desire. After carefully hearing your instructions, we prepare a hierarchal
                                    outline and complete it within the guaranteed time</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="publishing-work-card">
                                <img src="images/03.webp" alt="image">
                                <h4 class="theme-h3">Flawless Client Communication</h4>
                                <p class="theme-p">We never consider two different projects and clients the same. Our
                                    goal is to offer honest
                                    service and, subsequently, empathy to all the convincing clients.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
