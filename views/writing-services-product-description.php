...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-product-description/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                        Boost Your Sales with Compelling Product Descriptions
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our professional team generates high-quality product descriptions by highlighting key
                            features, incorporating money-making keywords, and using a convincing tone. Market and
                            product research makes our work more effective and gets you strategically developed
                            sales-boosting product descriptions.
                        </p>
                        <div class="btn-wrap">
