...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-business-proposals-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Bring Your Business Idea to Life with a Well-Written Proposal
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We are dedicated to helping businesses of all sizes create compelling, professional
                            proposals that win contracts, secure funding, and drive growth. Whether you are seeking
                            investment, responding to an RFP, or pitching a new product or service, our team of
                            experienced writers can help you craft a customized proposal. So, if you're ready to take
                            your business to the next level, contact us today!
                        </p>
                        <div class="btn-wrap">
