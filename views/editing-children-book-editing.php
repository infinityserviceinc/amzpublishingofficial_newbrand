...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get the Next Best-Selling Children's Book Edited by Professionals! 
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/editing-children-book-editing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our editors hold degrees in English, Creative Writing & Journalism. Most are also
                            kindergarten teachers who have pivoted to becoming editors for the love of the arts. Your
                            manuscript will be thoroughly reviewed by subject matter experts and fact-checked. Along
                            with proof-reading, we also copy-edit at a sentence level to fine-tune the text of your book
                            with a focus on clarity, coherency & consistency
