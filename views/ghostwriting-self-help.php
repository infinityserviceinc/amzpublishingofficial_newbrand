...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            ...
                            Share Your Experience & Insight with a Thought-Provoking Self-Help Book
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/ghostwriting-self-help/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Well-Researched Self-Help Books That Make An Impact
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Made the mistake of trying to cover everything under the sun? Don’t worry; you’re not alone.
                            Invite a positive impression on your readers with a self-help book that backs up its claims.
                            We create well-researched and motivating content to make your self-help book the go-to guide
                            for your desired demographic.
                        </p>
                        <div class="btn-wrap">
