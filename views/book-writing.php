                ...
                <div class="banner-content">
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-12">
                            <h6 class="theme-tagline"><strong>Book Writing</strong></h6>
                            <h1 class="theme-h1">Our Genre and Niche-specific Writers Are Ready to Pen it Down for You.
                            </h1>
                            <p class="theme-p">At AMZ Publishing Official, we translate your ideas, experiences, and
                                expertise into
                                words that resonate with you and your target audience. Our team of creative writers not
                                only specializes in a wide range of genres and niches but is an absolute delight to work
                                with</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-12 p-lg-5">
                        <img class="img-fluid" src="images/book-writng-sr.png" alt="image">
                    </div>
                    <div class="col-lg-6 col-12">
                        <h2 class="theme-h2">We Connect You with Book Writing Specialists of Your Genre and Niche.</h2>
                        <p class="theme-p">Having a book published under one's name is a dream we all share. But not all
                            of us have enough time or the required oomph to pen down a top-quality, publishable book.
                            This is where our ghostwriting expertise comes in handy. We help you realize the idea behind
                            your book by listening to you, drafting a structure, putting pen to paper, and in turn
                            producing a book worthy of attention. At AMZ Publishing Official, we align our goals with yours
                            and help
                            you speak your mind!</p>
                        <ul class="theme-btn-ul">
                            <li>
                                <a class="theme-btn theme-btn-dark btn-icon"
                                    href="javascript:;$zopim.livechat.window.toggle()">live chat</a>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="publishing-work-card">
                                        ...
                                        <p class="theme-p">With AMZ Publishing Official, the sky is your limit. Our
                                            experienced team
                                            of writers specializes in a wide variety of genres and niches. Whether it is
                                            an autobiography, a piece of fiction, or a wellresearched business
                                            publication – we ensure exceptional quality and unparalleled service.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="publishing-work-card">
                                        ...
                                        <p class="theme-p">We assign a dedicated team consisting of genre and
                                            niche-specific writers to your project based on your unique requirements. We
                                            patiently listen to your instructions, formulate a schematic outline and
                                            flesh it out into a complete book within the estimated time promised.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="publishing-work-card">
                                        ...
                                        <p class="theme-p">For us, no two clients and projects are alike. We offer a
                                            bespoke service and, henceforth, maintain a particular emphasis on effective
                                            client </p>
                                    </div>
                                </div>
                            </div>
