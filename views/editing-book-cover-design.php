...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Newsflash: People Judge Books by Their Covers
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/editing-book-cover-design/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Top-of-the-Line Book Cover Design Services
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            You will never get a second chance to tell your story that people perceive by reviewing the
                            frontal cover of your book. Our design team has the right savoir-faire to come up with the
                            most inimitable and pioneering cover design you are looking for. With our professionals at
                            work, we generate extraordinary designs that never go unnoticed.
                        </p>
                        <div class="btn-wrap">
