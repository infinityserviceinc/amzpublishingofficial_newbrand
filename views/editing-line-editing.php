...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Perfect Your Manuscript with Professional Line Editing Services
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/editing-line-editing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Got a great idea penned down, but it needs just a little extra something to make it a best
                            seller? A line editor helps you turn a good manuscript into a flawless one. We make sure
                            poor execution doesn’t hold you back from making your document stand out from the rest. We
                            don’t just fix grammatical errors and sentence structures – we perfect the prose. Swapping
                            cliches with creative metaphors and overused adjectives with fresher alternatives are just
                            some of the tricks up our sleeves.s .
                        </p>
                        <div class="btn-wrap">
