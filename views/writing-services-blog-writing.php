...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-blog-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Reinforce Your Brand & Increase Conversion Rate
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Blogging brings the opportunity for users to link back to your website, share your content,
                            and recommend your content to others. We help build brand credibility by producing
                            high-ranking content that will interest your audience and give them reasons to return to
                            your website. That’s what we aim to achieve with our blogs: engagement, reliability, and
                            trust.
                        </p>
                        <div class="btn-wrap">
