...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-brochures/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Improve Your Conversion Rates with Premiumly Crafted Brochures
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            We help brands speak to their customers directly through effective content strategies. Build
                            brand authority, credibility, and authenticity with high-quality content. Our expert writers
                            create customized brochure content to meet your brand requirements, from creative headings
                            to powerful call-to-action.
                        </p>
                        <div class="btn-wrap">
