...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            One-stop Shop for Your Publishing Needs
                        </p>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/publishing-self-publishing-service/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        <h2 data-aos="fade-down" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                            Top-Notch Self-Publishing Service
                        </h2>
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Looking to bring your book to life? Look no further than AMZ Publishing Official! We're here to help
                            you navigate the publishing process easily and confidently. Our experts will guide you
                            through every step, from formatting and design to marketing and distribution. Plus, you'll
                            enjoy competitive pricing and earn higher royalties than traditional publishing. So, why
                            wait? Let us help you make your dream a reality!
                        </p>
                        <div class="btn-wrap">
