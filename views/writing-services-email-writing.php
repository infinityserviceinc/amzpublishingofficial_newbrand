...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/writing-services-email-writing/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            Our professional writers deliver high-quality email content that not only provides your
                            message to the customers but also influences them to take the desired action through email.
                            Along with that, we effectively design email content so that it won’t look like spam or
                            avoid unsubscription.
                        </p>
                        <div class="btn-wrap">
