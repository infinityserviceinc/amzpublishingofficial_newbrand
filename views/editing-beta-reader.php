...
<body>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-12">
                    <div class="banner-content text-center" required data-aos="fade-right"
                        ...
                        <p class="banner-text mw-100">
                            Get Valuable Insights from Professional Beta Readers
                        </p>
    ...
    <section class="pt-lg-0 service">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="w-100" src="../assets/images/service/editing-beta-reader/1.webp" alt=""
                        loading="lazy">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="sec-heading ">
                        ...
                        <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                            You may have perfected the grammar for your first draft, but that doesn’t guarantee it as an
                            exciting read. Too emotionally invested in your project? Get an objective analysis complete
                            with research notes to tune your work for your audience. We give you comprehensive and
                            useful insights to make the editing process more straightforward.
                        </p>
                        <div class="btn-wrap">
