...
<body>
    ...
    <section class="banner" data-imgurl="assets/img/proofreading-banner.jpg">
        <div class="container">
            <div class="row d-block">
                <div class="banner__grid">
                    <div class="content">
                        <h5>LEVERAGE OUR SKILLS</h5>
                        <h1>PROOFREADING TO SERVICES TO CLEAN YOUR BOOK WITH A GLINT</h1>
                        <hr>
                        <div>
                            <p>Cover the necessary proofreading process before publishing with our services, and admit
                                to the refinery of sentences and vocab that buffs up entire chapters.</p>
                            <div class="btn-group">
                                <a href="get-a-quote/" class="btn btn-white">Get Free
                                    <strong>Consultation</strong></a>
                                <a href="javascript:void(Tawk_API.toggle())" class="btn btn-primary">Proofread
                                    <strong>My
                                        Book</strong></a>
                            </div>
                    ...
                    <div class="banner-slide wow fadeInRight">
                        <figure>
                            <img loading="lazy" src="assets/img/transparent.svg"
                                data-imgurl="assets/img/proofreading-img.png" class="w-100" alt="Ghost Writing">
                        </figure>
                ...
                <div class="col-md-10">
                    <div class="row align-items-center position-relative">
                        <div class="col-md-8 position-static">
                            <h2 data-letter="A">WE PROVIDE EASE OF MIND, AFFORDABILITY AND QUALITY</h2>
                            <hr>
                            <p>The proofreaders at AMZ Publishing Official may check your content for errors and fix
                                grammar problems like capitalization, spelling, sentence structure, and tenses. Our
                                proofreaders ensure that all of your book publishing requirements are satisfied by
                                ensuring that your publications are fully error-free.</p>
                            <div class="button">
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 mx-auto">
                    ...
                    <h4 class="heading">BRING OUT THE VALUE YOUR BOOK DESERVES WITHOUT RESOURCE
                    </h4>
                </div>
            </div>
            <div class="row mt-4">
                        ...
                        <div class="col-md-5">
                            <div class="card timeline-right-arrow">
                                <div class="card-body">
                                    ...
                                    <div class="card-text">
                                        The customer sends the article for editing. After that, it is examined by our
                                        proofreaders.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-4 timelineSec__box">
                        <div class="col-md-5 order-md-2">
                            <div class="card timeline-left-arrow">
                                <div class="card-body">
                                    <div class="card-title">
                                        Reading, examining, and ensuring accuracy
                                    </div>
                                    <div class="card-text">
                                        Our qualified proofreaders go over the content and fix any mistakes they
                                        uncover.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-4  timelineSec__box">
                        <div class="col-md-5">
                            <div class="card timeline-right-arrow">
                                <div class="card-body">
                                    <div class="card-title">
                                        Software for Scanning Errors
                                    </div>
                                    <div class="card-text">
                                        We put the completed manuscript using authorized proofreading software as the
                                        last step in the error-correction process to make sure the book is error-free
                                        throughout.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-4  timelineSec__box">
                        <div class="col-md-5 order-md-2">
                            <div class="card timeline-left-arrow">
                                <div class="card-body">
                                    <div class="card-title">
                                        Delivery of Documents of High Quality
                                    </div>
                                    <div class="card-text">
                                        When the software scanning process has authorized the finished document, we
                                        deliver it to the customer. When the book has been given the all-clear, we get
                ...
                <div class="col-md-10">
                    <div class="row align-items-center position-relative">
                        <div class="col-md-8 position-static">
                            ...
                            <hr>
                            <p>We are here to help you get on the right track. At AMZ Publishing Official, we offer
                                complete book
                                writing, editing, publishing, and marketing solutions!</p>
                            <div class="button">
                                <a href="get-a-quote/" class="btn btn__effect btn-hovereff">Get a Free Proposal</a>
                                <a href="javascript:void(Tawk_API.toggle())"
                                    class="btn btn__effect__trans__blcktext btn-hovereff">Talk to an Expert</a>
